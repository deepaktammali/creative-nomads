...
const Avatar = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
  return (
    <svg
          ...
          <g transform="translate(825.000000, 1100.000000)">
            ...
            >
              ...
              >
                ...
                <mask id="react-mask-1090" fill="white">
                  <use xlinkHref="#react-path-1089" />
                </mask>
                <use
                  id="Hoodie"
                  fill="#B7C1DB"
                  fill-rule="evenodd"
                  xlinkHref="#react-path-1089"
                />
                <g
                  id="Color/Palette/Gray-01"
                  mask="url(#react-mask-1090)"
                  fill-rule="evenodd"
                  fill="#929598"
                >
              ...
              >
                <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
                  ...
                  <mask id="react-mask-1094" fill="white">
                    <use xlinkHref="#react-path-1093" />
                  </mask>
                  <use
                    id="Mouth"
                    ...
                    fill="#000000"
                    fill-rule="evenodd"
                    xlinkHref="#react-path-1093"
                  />
                  <rect
                    id="Teeth"
                    fill="#FFFFFF"
                    fill-rule="evenodd"
                    mask="url(#react-mask-1094)"
                    x="39"
                    y="2"
                    width="31"
                    height="16"
              ...
              <g id="Top" stroke-width="1" fill-rule="evenodd">
                ...
                <mask id="react-mask-1135" fill="white">
                  <use xlinkHref="#react-path-1137" />
                </mask>
                <g id="Mask" />
                <g id="Top/Short-Hair/Short-Flat" mask="url(#react-mask-1135)">
                  <g transform="translate(-1.000000, 0.000000)">
                    ...
                    >
                      ...
                      <mask id="react-mask-1138" fill="white">
                        <use xlinkHref="#react-path-1139" />
                      </mask>
                      <use
                        id="Lite-Beard"
                        fill="#331B0C"
                        fill-rule="evenodd"
                        xlinkHref="#react-path-1139"
                      />
                      <g
                        id="Color/Hair/Brown"
                        mask="url(#react-mask-1138)"
                        fill="#2C1B18"
                      >
                        <g
                    ...
                    <mask id="react-mask-1134" fill="white">
                      <use xlinkHref="#react-path-1136" />
                    </mask>
                    <use
                      id="Short-Hair"
                      stroke="none"
                      fill="#1F3140"
                      fill-rule="evenodd"
                      xlinkHref="#react-path-1136"
                    />
                    <g
                      id="Skin/👶🏽-03-Brown"
                      mask="url(#react-mask-1134)"
                      fill="#2C1B18"
                    >
                      <g transform="translate(0.000000, 0.000000) " id="Color">
                        <rect x="0" y="0" width="264" height="280" />
                    ...
                    >
                      ...
                      <g id="Lennon-Glasses">
                        <use
                          fill="black"
                          fill-opacity="1"
                          filter="url(#react-filter-1141)"
                          xlinkHref="#react-path-1140"
                        />
                        <use
                          fill="#252C2F"
                          fill-rule="evenodd"
